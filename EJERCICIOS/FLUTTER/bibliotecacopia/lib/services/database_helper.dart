...
class DatabaseHelper {
  ...
  static final CollectionReference librosCollection = _firestore.collection('Libros');
...
class DatabaseHelper {
  ...
  Future<Database> _initDatabase() async {
    ...
    return await openDatabase(
      ...
      onCreate: (db, version) {
        return db.execute(
          'CREATE TABLE books (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, author TEXT, status TEXT, note TEXT)',
        );
      },
    );
  }
